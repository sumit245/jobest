            ...
            <div className='container-fluid p-4 bg-primary'>
                <div className='row'>
                    <div className='col-10'>
                        <h5 className="mb-0 text-white">Join us in reshaping the way we hire and earn your profit from merely referring a friend</h5>
                    </div>
                    <div className='col-2'>
                        <a className="btn btn-primary btn-lg" href="signin">Refer now !</a>
                    </div>
                </div>
            </div>
